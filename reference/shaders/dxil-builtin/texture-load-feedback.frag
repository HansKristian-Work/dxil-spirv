...
void main()
{
    uint _304;
    vec4 _305;
    _304 = sparseTexelFetchOffsetARB(_8, int(TEXCOORD.x), int(TEXCOORD.y), 0, _305);
    SparseTexel _78 = SparseTexel(_304, _305);
    vec4 _80 = _78._m1;
    _85 _86 = _85(_80.x, _80.y, _80.z, _80.w, _78._m0);
    float _92 = float(sparseTexelsResidentARB(int(_86._m4)));
    uint _306;
    vec4 _307;
    _306 = sparseTexelFetchOffsetARB(_11, ivec2(uvec2(TEXCOORD.x, TEXCOORD.y)), int(TEXCOORD.z), 0, _307);
    SparseTexel _97 = SparseTexel(_306, _307);
    vec4 _101 = _97._m1;
    _85 _106 = _85(_101.x, _101.y, _101.z, _101.w, _97._m0);
    float _113 = float(sparseTexelsResidentARB(int(_106._m4)));
    uint _308;
    vec4 _309;
    _308 = sparseTexelFetchOffsetARB(_14, ivec2(uvec2(TEXCOORD.x, TEXCOORD.y)), int(TEXCOORD.z), ivec2(0), _309);
    SparseTexel _116 = SparseTexel(_308, _309);
    vec4 _121 = _116._m1;
    _85 _126 = _85(_121.x, _121.y, _121.z, _121.w, _116._m0);
    float _133 = float(sparseTexelsResidentARB(int(_126._m4)));
    uint _310;
    vec4 _311;
    _310 = sparseTexelFetchOffsetARB(_17, ivec3(uvec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z)), int(TEXCOORD.w), ivec2(0), _311);
    SparseTexel _136 = SparseTexel(_310, _311);
    vec4 _140 = _136._m1;
    _85 _145 = _85(_140.x, _140.y, _140.z, _140.w, _136._m0);
    float _152 = float(sparseTexelsResidentARB(int(_145._m4)));
    uint _312;
    vec4 _313;
    _312 = sparseTexelFetchOffsetARB(_20, ivec3(uvec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z)), int(TEXCOORD.w), ivec3(0), _313);
    SparseTexel _155 = SparseTexel(_312, _313);
    vec4 _160 = _155._m1;
    _85 _165 = _85(_160.x, _160.y, _160.z, _160.w, _155._m0);
    float _172 = float(sparseTexelsResidentARB(int(_165._m4)));
    uint _314;
    vec4 _315;
    _314 = sparseTexelFetchOffsetARB(_23, ivec2(uvec2(TEXCOORD.x, TEXCOORD.y)), ivec2(0), TEXCOORD.z, _315);
    SparseTexel _175 = SparseTexel(_314, _315);
    vec4 _178 = _175._m1;
    _85 _183 = _85(_178.x, _178.y, _178.z, _178.w, _175._m0);
    float _190 = float(sparseTexelsResidentARB(int(_183._m4)));
    uint _316;
    vec4 _317;
    _316 = sparseTexelFetchOffsetARB(_26, ivec3(uvec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z)), ivec2(0), TEXCOORD.w, _317);
    SparseTexel _193 = SparseTexel(_316, _317);
    vec4 _196 = _193._m1;
    _85 _201 = _85(_196.x, _196.y, _196.z, _196.w, _193._m0);
    float _208 = float(sparseTexelsResidentARB(int(_201._m4)));
    uint _318;
    vec4 _319;
    _318 = sparseImageLoadARB(_29, int(TEXCOORD.x), _319);
    SparseTexel _211 = SparseTexel(_318, _319);
    vec4 _213 = _211._m1;
    _85 _218 = _85(_213.x, _213.y, _213.z, _213.w, _211._m0);
    float _225 = float(sparseTexelsResidentARB(int(_218._m4)));
    uint _320;
    vec4 _321;
    _320 = sparseImageLoadARB(_32, ivec2(uvec2(TEXCOORD.x, TEXCOORD.y)), _321);
    SparseTexel _228 = SparseTexel(_320, _321);
    vec4 _231 = _228._m1;
    _85 _236 = _85(_231.x, _231.y, _231.z, _231.w, _228._m0);
    float _243 = float(sparseTexelsResidentARB(int(_236._m4)));
    uint _322;
    vec4 _323;
    _322 = sparseImageLoadARB(_35, ivec2(uvec2(TEXCOORD.x, TEXCOORD.y)), _323);
    SparseTexel _246 = SparseTexel(_322, _323);
    vec4 _249 = _246._m1;
    _85 _254 = _85(_249.x, _249.y, _249.z, _249.w, _246._m0);
    float _261 = float(sparseTexelsResidentARB(int(_254._m4)));
    uint _324;
    vec4 _325;
    _324 = sparseImageLoadARB(_38, ivec3(uvec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z)), _325);
    SparseTexel _264 = SparseTexel(_324, _325);
    vec4 _267 = _264._m1;
    _85 _272 = _85(_267.x, _267.y, _267.z, _267.w, _264._m0);
    float _279 = float(sparseTexelsResidentARB(int(_272._m4)));
    uint _326;
    vec4 _327;
    _326 = sparseImageLoadARB(_41, ivec3(uvec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z)), _327);
    SparseTexel _282 = SparseTexel(_326, _327);
    vec4 _285 = _282._m1;
