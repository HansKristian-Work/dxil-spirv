...
void main()
{
    ...
    SV_Target = (((((((((((((((((((((((((((((((((((((uint(textureSize(_8, int(LEVEL))) + 32u) + _90.y) + _90.x) + _93.y) + _93.x) + _97.y) + _97.x) + _97.z) + _101.y) + _101.x) + _104.y) + _104.x) + _104.z) + _108.y) + _108.x) + _108.z) + _112.y) + _112.x) + _115.y) + _115.x) + _115.z) + (_119 * _119)) + (_121 * _121)) + _123.y) + _123.x) + _126.y) + _126.x) + _129.y) + _129.x) + _129.z) + _133.y) + _133.x) + _133.z) + (_137 * _137)) + (_140 * _140)) + (_144 * _144)) + (_147 * _147)) + (_150 * _150);
}
