...
void main()
{
    vec4 _49 = textureGather(sampler2D(_8, _20), vec2(TEXCOORD.x, TEXCOORD.y));
    vec4 _58 = textureGather(sampler2DArray(_11, _20), vec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z), 1u);
    vec4 _70 = textureGather(samplerCube(_14, _20), vec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z), 2u);
    vec4 _82 = textureGather(samplerCubeArray(_17, _20), vec4(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z, TEXCOORD.w), 3u);
