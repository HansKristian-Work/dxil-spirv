...
define void @main() {
  ...
  %13 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %7, %dx.types.Handle %8, float %9, float undef, float undef, float undef, i32 0, i32 undef, i32 undef, float undef)
  %14 = extractvalue %dx.types.ResRet.f32 %13, 0
  %15 = extractvalue %dx.types.ResRet.f32 %13, 1
  %16 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %6, %dx.types.Handle %8, float %9, float %10, float undef, float undef, i32 0, i32 undef, i32 undef, float undef)
  %17 = extractvalue %dx.types.ResRet.f32 %16, 0
  %18 = fadd fast float %17, %14
  %19 = fadd fast float %17, %15
  %20 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %5, %dx.types.Handle %8, float %9, float %10, float undef, float undef, i32 0, i32 0, i32 undef, float undef)
  ...
  %25 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %4, %dx.types.Handle %8, float %9, float %10, float %11, float undef, i32 0, i32 0, i32 undef, float undef)
  %26 = extractvalue %dx.types.ResRet.f32 %25, 0
  %27 = fadd fast float %23, %26
  %28 = fadd fast float %24, %26
  %29 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %3, %dx.types.Handle %8, float %9, float %10, float %11, float undef, i32 0, i32 0, i32 0, float undef)
  ...
  %34 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %2, %dx.types.Handle %8, float %9, float %10, float %11, float undef, i32 undef, i32 undef, i32 undef, float undef)
  ...
  %39 = call %dx.types.ResRet.f32 @dx.op.sample.f32(i32 60, %dx.types.Handle %1, %dx.types.Handle %8, float %9, float %10, float %11, float %12, i32 undef, i32 undef, i32 undef, float undef)
...
%88 = OpImageSampleImplicitLod %30 %86 %89 ConstOffset %80
%91 = OpCompositeExtract %5 %88 0
%92 = OpFAdd %5 %83 %91
%93 = OpFAdd %5 %84 %91
%95 = OpSampledImage %96 %38 %43
%98 = OpCompositeConstruct %90 %48 %51 %54
%97 = OpImageSampleImplicitLod %30 %95 %98 ConstOffset %100
...
%108 = OpImageSampleImplicitLod %30 %106 %109 None
...
%117 = OpImageSampleImplicitLod %30 %115 %118 None
