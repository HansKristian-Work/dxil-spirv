...
define void @main() {
  ...
  %FMin = call float @dx.op.binary.f32(i32 36, float %1, float %2)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %FMin)
  ret void
}
...
!10 = !{!11, !14, null}
!11 = !{!12}
!12 = !{i32 0, !"A", i8 9, i8 0, !13, i8 2, i32 1, i8 2, i32 0, i8 0, null}
!13 = !{i32 0}
!14 = !{!15}
