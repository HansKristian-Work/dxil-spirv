...
define void @main() {
  ...
  %IMad = call i32 @dx.op.tertiary.i32(i32 48, i32 %1, i32 %2, i32 %3)
  call void @dx.op.storeOutput.i32(i32 5, i32 0, i32 0, i8 0, i32 %IMad)
  ret void
}
...
!10 = !{!11, !14, null}
!11 = !{!12}
!12 = !{i32 0, !"A", i8 4, i8 0, !13, i8 1, i32 1, i8 3, i32 0, i8 0, null}
!13 = !{i32 0}
!14 = !{!15}
