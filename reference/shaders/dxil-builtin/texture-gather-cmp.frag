...
void main()
{
    vec2 _59 = vec2(TEXCOORD.x, TEXCOORD.y);
    vec4 _60 = textureGather(sampler2DShadow(_8, _20), _59, TEXCOORD.z);
    vec3 _68 = vec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z);
    vec4 _69 = textureGather(sampler2DArrayShadow(_11, _20), _68, TEXCOORD.w);
    vec3 _80 = vec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z);
    vec4 _81 = textureGather(samplerCubeShadow(_14, _20), _80, TEXCOORD.w);
    vec4 _92 = vec4(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z, TEXCOORD.w);
    vec4 _93 = textureGather(samplerCubeArrayShadow(_17, _20), _92, TEXCOORD.w);
    vec2 _102 = vec2(TEXCOORD.x, TEXCOORD.y);
    vec4 _105 = textureGatherOffset(sampler2DShadow(_8, _20), _102, TEXCOORD.z, ivec2(int(uint(OFF.x)), int(uint(OFF.y))));
...
%60 = OpImageDrefGather %21 %57 %59 %52
...
%69 = OpImageDrefGather %21 %66 %68 %55
...
%81 = OpImageDrefGather %21 %79 %80 %55
...
%93 = OpImageDrefGather %21 %91 %92 %55
...
%105 = OpImageDrefGather %21 %57 %102 %52 Offset %106
