...
define void @main() {
  ...
  %FirstbitSHi = call i32 @dx.op.unaryBits.i32(i32 34, i32 %1)
  %2 = sub i32 31, %FirstbitSHi
  %3 = icmp eq i32 %FirstbitSHi, -1
...
!10 = !{!11, !14, null}
!11 = !{!12}
!12 = !{i32 0, !"A", i8 4, i8 0, !13, i8 1, i32 1, i8 1, i32 0, i8 0, null}
!13 = !{i32 0}
!14 = !{!15}
