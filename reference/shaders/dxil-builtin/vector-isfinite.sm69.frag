...
void main()
{
    ...
    bvec3 _38 = isnan(_29);
    bvec3 _39 = isinf(_29);
    vec3 _47 = vec3(not(bvec3(_38.x || _39.x, _38.y || _39.y, _38.z || _39.z))) * _17;
    SV_Target.x = _47.x;
    SV_Target.y = _47.y;
    SV_Target.z = _47.z;
}
...
%42 = OpConstant %5 0
%43 = OpConstant %5 1
%44 = OpConstantComposite %6 %42 %42 %42
%45 = OpConstantComposite %6 %43 %43 %43
...
%38 = OpIsNan %37 %35
%39 = OpIsInf %37 %35
%40 = OpLogicalOr %37 %38 %39
%41 = OpLogicalNot %37 %40
%46 = OpSelect %6 %41 %45 %44
%47 = OpFMul %6 %46 %26
%48 = OpCompositeExtract %5 %47 0
%50 = OpAccessChain %49 %11 %15
OpStore %50 %48
%51 = OpCompositeExtract %5 %47 1
%52 = OpAccessChain %49 %11 %20
OpStore %52 %51
%53 = OpCompositeExtract %5 %47 2
%54 = OpAccessChain %49 %11 %24
OpStore %54 %53
OpReturn
OpFunctionEnd
#endif
