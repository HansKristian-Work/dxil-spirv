...
void main()
{
    ...
    SV_Target.x = float(((((_216.x + float16_t(_201 + unpackHalf2x16(packHalf2x16(vec2(_190))).x)) + _227.x) + _243.x) + _254.x) + _264.x);
    SV_Target.y = float(((((_216.y + float16_t(_201 + unpackHalf2x16(packHalf2x16(vec2(_191))).x)) + _227.y) + _243.y) + _254.y) + _264.y);
    SV_Target.z = float(((((_216.z + float16_t(_201 + unpackHalf2x16(packHalf2x16(vec2(_192))).x)) + _227.z) + _243.z) + _254.z) + _264.z);
    SV_Target.w = float(((((_216.w + float16_t(_201 + unpackHalf2x16(packHalf2x16(vec2(_193))).x)) + _227.w) + _243.w) + _254.w) + _264.w);
