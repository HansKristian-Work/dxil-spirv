...
define void @main() {
  ...
  %2 = add i32 %1, 0
  %3 = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 0, i32 %2, i1 true)
...
!4 = !{null, !5, null, null}
!5 = !{!6}
!6 = !{i32 0, [0 x %"class.RWStructuredBuffer<vector<float, 4> >"]* undef, !"", i32 0, i32 0, i32 -1, i32 12, i1 false, i1 false, i1 false, !7}
!7 = !{i32 1, i32 16}
