...
define void @main() {
  ...
  %2 = shl i32 %1, 4
  %3 = add i32 %1, 0
  %4 = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 1, i32 0, i32 %3, i1 false)
...
!4 = !{null, !5, null, null}
!5 = !{!6}
!6 = !{i32 0, [0 x %struct.RWByteAddressBuffer]* undef, !"", i32 0, i32 0, i32 -1, i32 11, i1 false, i1 false, i1 false, null}
