...
void main()
{
    ...
    SV_Target.x = float(((((_298.x + float16_t(_283 + unpackHalf2x16(packHalf2x16(vec2(_272))).x)) + _309.x) + _325.x) + _336.x) + _346.x);
    SV_Target.y = float(((((_298.y + float16_t(_283 + unpackHalf2x16(packHalf2x16(vec2(_273))).x)) + _309.y) + _325.y) + _336.y) + _346.y);
    SV_Target.z = float(((((_298.z + float16_t(_283 + unpackHalf2x16(packHalf2x16(vec2(_274))).x)) + _309.z) + _325.z) + _336.z) + _346.z);
    SV_Target.w = float(((((_298.w + float16_t(_283 + unpackHalf2x16(packHalf2x16(vec2(_275))).x)) + _309.w) + _325.w) + _336.w) + _346.w);
