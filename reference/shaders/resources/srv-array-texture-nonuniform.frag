...
void main()
{
    vec4 _36 = textureOffset(nonuniformEXT(sampler2D(_9[INDEX + 0u], _17)), vec2(0.5), ivec2(0));
    vec4 _51 = textureOffset(nonuniformEXT(sampler2D(_14[(INDEX ^ 1u) + 0u], _17)), vec2(0.5), ivec2(0));
