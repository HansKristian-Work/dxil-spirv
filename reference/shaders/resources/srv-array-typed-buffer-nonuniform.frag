...
define void @main() {
  ...
  %2 = add i32 %1, 0
  %3 = call %dx.types.Handle @dx.op.createHandle(i32 57, i8 0, i32 0, i32 %2, i1 true)
...
!4 = !{!5, null, null, null}
!5 = !{!6}
!6 = !{i32 0, [0 x %"class.Buffer<vector<float, 4> >"]* undef, !"", i32 0, i32 0, i32 -1, i32 10, i32 0, !7}
!7 = !{i32 0, i32 9}
