...
define void @main() {
  ...
  %5 = call i1 @dx.op.isSpecialFloat.f32(i32 8, float %1)
  %6 = call i1 @dx.op.isSpecialFloat.f32(i32 8, float %2)
  %7 = xor i1 %5, %6
  %8 = select i1 %7, float %3, float %4
