...
define void @main() {
  ...
  %10 = fadd fast float %6, 0x3F847AE140000000
  %11 = fadd fast float %7, 0x3F847AE140000000
  %12 = fadd fast float %8, 0x3F847AE140000000
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %1)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %2)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %3)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %4)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 0, float %9)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 1, float %10)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 2, float %11)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 3, float %12)
  call void @dx.op.emitStream(i32 97, i8 0)
  ret void
}
...
!12 = !{i32 1, !13}
!13 = !{i32 3, i32 2, i32 1, i32 3, i32 1}
#endif
#if 0
// SPIR-V disassembly
; SPIR-V
...
%48 = OpFAdd %5 %33 %46
%49 = OpFAdd %5 %35 %46
%50 = OpInBoundsAccessChain %37 %14 %18
OpStore %50 %19
%51 = OpInBoundsAccessChain %37 %14 %21
OpStore %51 %22
%52 = OpInBoundsAccessChain %37 %14 %24
OpStore %52 %25
%53 = OpInBoundsAccessChain %37 %14 %8
OpStore %53 %27
%54 = OpInBoundsAccessChain %37 %15 %18
OpStore %54 %45
%55 = OpInBoundsAccessChain %37 %15 %21
OpStore %55 %47
%56 = OpInBoundsAccessChain %37 %15 %24
OpStore %56 %48
