...
%_ptr_Image_uint = OpTypePointer Image %uint
     %uint_5 = OpConstant %uint 5
       %main = OpFunction %void None %2
         ...
         %43 =   OpLoad %uint %42
         %45 =   OpLoad %uint %VALUE
         %46 =   OpCompositeConstruct %v3uint %38 %41 %43
         %48 =   OpImageTexelPointer %_ptr_Image_uint %35 %46 %uint_0
         %49 =   OpAtomicIAdd %uint %48 %uint_5 %uint_0 %45
