   ...
   %uint_140 = OpConstant %uint 140
     %uint_6 = OpConstant %uint 6
       %main = OpFunction %void None %2
         ...
         %24 =   OpLoad %uint %22
         %32 =   OpIMul %uint %21 %uint_20
         %34 =   OpShiftRightLogical %uint %24 %uint_2
         %35 =   OpIAdd %uint %32 %34
