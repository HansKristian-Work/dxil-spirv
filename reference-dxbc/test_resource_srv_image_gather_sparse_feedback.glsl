...
void main()
{
    ...
    SV_TARGET.z = _66;
    SV_TARGET.w = _67;
    SV_TARGET_1 = float(sparseTexelsResidentARB(int(_63)));
    uint _136;
    vec4 _137;
    ...
    SV_TARGET_2.z = _97;
    SV_TARGET_2.w = _98;
    SV_TARGET_3 = float(sparseTexelsResidentARB(int(_94)));
    uint _138;
    vec4 _139;
    _138 = sparseTextureGatherOffsetARB(sampler2D(_8, _11), vec2(TEXCOORD.x, TEXCOORD.y), ivec2(int(_44), int(_47)), _139);
    ...
    SV_TARGET_4.z = _122;
    SV_TARGET_4.w = _123;
    SV_TARGET_5 = float(sparseTexelsResidentARB(int(_119)));
}
