    ...
    %v4float = OpTypeVector %float 4
     ...
     %int_n1 = OpConstant %int -1
      ...
      %v2int = OpTypeVector %int 2
         %76 = OpConstantComposite %v2int %int_n1 %int_0
       %main = OpFunction %void None %2
         ...
         %66 =   OpCompositeConstruct %v2float %53 %56
         %65 =   OpImageSampleDrefImplicitLod %float %63 %66 %58 None
         %68 =   OpCompositeConstruct %v4float %65 %65 %65 %65
         %69 =   OpCompositeExtract %float %68 0
                 OpStore %SV_TARGET %69
         %74 =   OpCompositeConstruct %v2float %53 %56
         %73 =   OpImageSampleDrefImplicitLod %float %63 %74 %58 ConstOffset %76
         %77 =   OpCompositeConstruct %v4float %73 %73 %73 %73
         %78 =   OpCompositeExtract %float %77 0
                 OpStore %SV_TARGET_1 %78
         %80 =   OpCompositeConstruct %v2float %53 %56
         %79 =   OpImageSampleDrefExplicitLod %float %63 %80 %58 Lod %float_0
         %81 =   OpCompositeConstruct %v4float %79 %79 %79 %79
         %82 =   OpCompositeExtract %float %81 0
                 OpStore %SV_TARGET_2 %82
                 OpReturn
               OpFunctionEnd
