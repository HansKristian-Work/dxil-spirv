...
void main()
{
    ...
    uint _65 = uint(OFFSET.x);
    uint _68 = uint(OFFSET.y);
    ...
    vec4 _136 = textureGatherOffset(nonuniformEXT(sampler2D(_9[_48], _19[_48])), vec2(TEXCOORD.x, TEXCOORD.y), ivec2(int(_65), int(_68)));
    float _138 = _136.x;
    SV_TARGET_5.x = _138;
