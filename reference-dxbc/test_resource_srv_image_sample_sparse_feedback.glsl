...
void main()
{
    ...
    SV_TARGET.z = _67;
    SV_TARGET.w = _68;
    SV_TARGET_1 = float(sparseTexelsResidentARB(int(_64)));
    uint _169;
    vec4 _170;
    ...
    SV_TARGET_2.z = _94;
    SV_TARGET_2.w = _95;
    SV_TARGET_3 = float(sparseTexelsResidentARB(int(_91)));
    uint _171;
    vec4 _172;
    ...
    SV_TARGET_4.z = _121;
    SV_TARGET_4.w = _122;
    SV_TARGET_5 = float(sparseTexelsResidentARB(int(_118)));
    float _133 = dFdx(TEXCOORD_2.x);
    float _134 = dFdy(TEXCOORD_2.x);
    float _137 = dFdx(TEXCOORD_2.y);
    float _138 = dFdy(TEXCOORD_2.y);
    uint _173;
    vec4 _174;
    _173 = sparseTextureGradARB(sampler2DArray(_8, _11), vec3(TEXCOORD.x, TEXCOORD.y, LAYER), vec2(_133, _137), vec2(_134, _138), _174);
    ...
    SV_TARGET_6.z = _155;
    SV_TARGET_6.w = _156;
    SV_TARGET_7 = float(sparseTexelsResidentARB(int(_152)));
}
