...
%_ptr_UniformConstant_16 = OpTypePointer UniformConstant %16
     %uint_1 = OpConstant %uint 1
         %62 = OpTypeImage %float 2D 1 1 0 1 Unknown
    ...
    %v4float = OpTypeVector %float 4
     ...
     %int_n1 = OpConstant %int -1
      ...
      %v2int = OpTypeVector %int 2
         %77 = OpConstantComposite %v2int %int_n1 %int_0
       %main = OpFunction %void None %2
         ...
         %67 =   OpCompositeConstruct %v3float %53 %56 %59
         %66 =   OpImageSampleDrefImplicitLod %float %64 %67 %58 None
         %69 =   OpCompositeConstruct %v4float %66 %66 %66 %66
         %70 =   OpCompositeExtract %float %69 0
                 OpStore %SV_TARGET %70
         %75 =   OpCompositeConstruct %v3float %53 %56 %59
         %74 =   OpImageSampleDrefImplicitLod %float %64 %75 %58 ConstOffset %77
         %78 =   OpCompositeConstruct %v4float %74 %74 %74 %74
         %79 =   OpCompositeExtract %float %78 0
                 OpStore %SV_TARGET_1 %79
         %81 =   OpCompositeConstruct %v3float %53 %56 %59
         %80 =   OpImageSampleDrefExplicitLod %float %64 %81 %58 Lod %float_0
         %82 =   OpCompositeConstruct %v4float %80 %80 %80 %80
         %83 =   OpCompositeExtract %float %82 0
                 OpStore %SV_TARGET_2 %83
                 OpReturn
               OpFunctionEnd
