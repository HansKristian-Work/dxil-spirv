...
void main()
{
    ...
    vec4 _130 = textureGrad(nonuniformEXT(samplerCube(_9[_46], _19[_46])), vec3(TEXCOORD.x, TEXCOORD.y, TEXCOORD.z), vec3(dFdx(TEXCOORD_2.x), dFdx(TEXCOORD_2.y), dFdx(TEXCOORD_2.z)), vec3(dFdy(TEXCOORD_2.x), dFdy(TEXCOORD_2.y), dFdy(TEXCOORD_2.z)));
    SV_TARGET_4.x = _130.x;
