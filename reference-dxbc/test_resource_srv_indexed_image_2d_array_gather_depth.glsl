...
void main()
{
    ...
    uint _64 = uint(OFFSET.x);
    uint _67 = uint(OFFSET.y);
    ...
    vec4 _103 = textureGatherOffset(nonuniformEXT(sampler2DArrayShadow(_9[_45], _19[_45])), _100, DEPTH_REF, ivec2(int(_64), int(_67)));
    float _105 = _103.x;
    SV_TARGET_2.x = _105;
