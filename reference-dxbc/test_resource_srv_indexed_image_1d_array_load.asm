...
%_ptr_Output_float = OpTypePointer Output %float
     ...
     %int_n1 = OpConstant %int -1
       %main = OpFunction %void None %2
         ...
         %39 =   OpLoad %uint %38
         %43 =   OpCompositeConstruct %v2uint %39 %uint_2
         %41 =   OpImageFetch %v4float %36 %43 Lod %uint_1
         %44 =   OpCompositeExtract %float %41 0
         %45 =   OpCompositeExtract %float %41 1
         %46 =   OpCompositeExtract %float %41 2
         %47 =   OpCompositeExtract %float %41 3
         ...
         %53 =   OpAccessChain %_ptr_Output_float %SV_TARGET %uint_3
                 OpStore %53 %47
         %58 =   OpCompositeConstruct %v2uint %39 %uint_2
         %57 =   OpImageFetch %v4float %36 %58 Lod|ConstOffset %uint_1 %int_n1
