...
void main()
{
    ...
    SV_TARGET_4.x = _124.x;
    SV_TARGET_4.y = _124.y;
    SV_TARGET_4.z = _124.z;
    SV_TARGET_4.w = _124.w;
    vec4 _137 = textureGatherOffset(nonuniformEXT(sampler2DArray(_9[_48], _19[_48])), vec3(TEXCOORD.x, TEXCOORD.y, LAYER), ivec2(int(uint(OFFSET.x)), int(uint(OFFSET.y))));
    SV_TARGET_5.x = _137.x;
